...
namespace QuanLiTrungTamAnhNgu
{
    ...
    public partial class EnglishCenterEntities2 : DbContext
    {
        public EnglishCenterEntities2()
            : base("name=EnglishCenterEntities2")
        {
        }
        ...
        public virtual DbSet<NhomTaiLieu> NhomTaiLieux { get; set; }
